...
export default function Reviews(){
    ...
    const reviews = [
        ...
        { id: 3, img: i3, name: '@BhavanaSports', designation: 'visited march 2024', about:"We enjoyed a diverse menu with rich, authentic flavors.Clean, cozy, and perfect for family dinners or dates. Truly an unforgettable and relaxing evening." },
        { id: 4, img: i4, name: '@abishekSharma', designation: 'visited january 2025', about:"Clean, well-decorated interiors and a refreshing vibe made us feel at home.Service was top-notch and the menu had delightful variety." },
        ...
        { id: 6, img: i7, name: '@karthikS', designation: 'visited may 2025', about:"Amazing place with friendly staff. Every dish was deliclouse and well made. Really happy with the food and service Loved the atmoshpere and service too!" },
        ...
        <div className="p-4 bg-[#cccc] bg-cover min-h-screen">
           ...
           <div className="p-2 md:p-[50px]">
                <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mb-3 gap-4">
                    {reviews.map((review)=>(
                        <div className="hover:bg-[#ccc] bg-[white] pt-3 border border-black rounded overflow-hidden" key={review.id}>
                            <div className="p-4 py-5 px-5">
                                ...
                                <div className='flex mt-7'>
                                    ...
                                    <div className='px-5 flex-1 min-w-0'>
                                        <p className='font-bold text-sm sm:text-base break-words overflow-hidden'>{review.name}</p>
